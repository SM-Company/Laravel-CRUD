...
class ProductosController extends Controller
{
    ...
    public function index()
    {
        ...
        $productos = Producto::where('UserId', auth()->id())->get();
    ...
    public function store(CreateProductosRequest $request)
    {
        ...
        // $this->validate($request, ['NombreArticulo' => 'required', 'Seccion' => 'required', 'Precio' => 'required', 'Fecha' => 'required', 'PaisOrigen' => 'required',]);
